...
![Release](https://img.shields.io/badge/release-v1.1.2-blue?style=flat-square)
...
### ⬇️ Download Eidolon v1.1.2

[![Download Windows x64](https://img.shields.io/badge/⬇_Download-Windows_x64-2ea44f?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/Oykdo/Eidolon/releases/download/v1.1.2/Eidolon.exe)
[![Download Linux x64](https://img.shields.io/badge/⬇_Download-Linux_x64-2ea44f?style=for-the-badge&logo=linux&logoColor=white)](https://github.com/Oykdo/Eidolon/releases/download/v1.1.2/Eidolon-1.1.2-linux-x64.tar.gz)

<sub>Or grab the [full release page](https://github.com/Oykdo/Eidolon/releases/tag/v1.1.2) with archives + `SHA256SUMS`.</sub>
